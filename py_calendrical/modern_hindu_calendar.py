from core import iround, signum, angle, mod, ceiling, ifloor
...
def sacred_wednesdays_in_range(date_range):
    """Return the list of Wednesdays within date_range of dates
    that are day 8 of Hindu lunar months."""
    a      = start(date_range)
    b      = end(date_range)
